...
public class LimeLight extends SubsystemBase{
  ...
  private SpeedControllerGroup m_LeftMotors = new SpeedControllerGroup(leftFront1);
  private SpeedControllerGroup m_RightMotors = new SpeedControllerGroup(rightFront1);
