...
// New import com.ctre.phoenix.motorcontrol.can.WPI_VictorSPX;
...
public class DriveTrainTrial extends SubsystemBase {
   ...
   // New public static SpeedController leftFront;
   // New public static SpeedController rightFront;
   // New public static SpeedController leftBack;
   // New public static SpeedController rightBack;
  ...
  public DriveTrainTrial() {
    ...
    leftBack = new PWMVictorSPX(Constants.LEFT_BACK);
    leftBack.setInverted(true);
    rightFront = new PWMVictorSPX(Constants.RIGHT_FRONT);
    rightFront.setInverted(true);
    rightBack = new PWMVictorSPX(Constants.RIGHT_BACK);
